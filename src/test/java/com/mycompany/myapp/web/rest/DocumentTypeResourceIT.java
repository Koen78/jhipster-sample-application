...
class DocumentTypeResourceIT {
    ...
    public static DocumentType createEntity(EntityManager em) {
        DocumentType documentType = new DocumentType().objectId(DEFAULT_OBJECT_ID).code(DEFAULT_CODE);
        return documentType;
    }
    ...
    public static DocumentType createUpdatedEntity(EntityManager em) {
        DocumentType documentType = new DocumentType().objectId(UPDATED_OBJECT_ID).code(UPDATED_CODE);
        return documentType;
    }
    ...
    void createDocumentType() throws Exception {
        ...
        assertThat(testDocumentType.getObjectId()).isEqualTo(DEFAULT_OBJECT_ID);
    ...
    void putNewDocumentType() throws Exception {
        ...
        updatedDocumentType.objectId(UPDATED_OBJECT_ID).code(UPDATED_CODE);
        ...
        DocumentType testDocumentType = documentTypeList.get(documentTypeList.size() - 1);
        assertThat(testDocumentType.getObjectId()).isEqualTo(UPDATED_OBJECT_ID);
    ...
    void fullUpdateDocumentTypeWithPatch() throws Exception {
        ...
        partialUpdatedDocumentType.objectId(UPDATED_OBJECT_ID).code(UPDATED_CODE);
